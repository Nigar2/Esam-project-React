                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 mt-5">
                        <div className="login_cards">
                            <form action="#">
                                <input type="password" placeholder="Kodu daxil et" />
                                <div className="code">
                                    <p>daxil edilən e-mail ünvanına təsdiq kodu göndərildi!</p>
                                </div>
                                <div className="loginbtn">
                                    <button className="btn">
                                        <a href="">
                                        <Link to={"/parol3"}>Növbəti</Link>
                                        </a>
                                    </button>
                                </div>
                                <div className="tesdiq">
                                    <a href="">
                                        <Link to={"/tesdiq"}>Təsdiq kodu yenidən göndər</Link>
                                    </a>
